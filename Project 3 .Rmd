...
dotPlot(mPPARARNAseq, hPPARARNAseq, wsize = 9, wstep = 9, nmatch = 8) #Nucleotide similarity visualization
dotPlot(mPPARAProseq, hPPARAProseq, wsize = 5, wstep = 5, nmatch = 4) #Amino acid similarity visualization
```
